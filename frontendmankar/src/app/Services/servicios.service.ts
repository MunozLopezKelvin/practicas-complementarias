...
@Injectable({
  ...
  export class ServiciosService {
    ...
    getTiposMantenimientos() {
      return this.http.get<RespTiposMantenimientos>(`${this.apiUrl}/tiposmantenimientos`);
    }
  
    addTipoMantenimiento(tipoMantenimiento: TiposMantenimientos) {
      return this.http.post<TiposMantenimientos>(`${this.apiUrl}/tiposmantenimientos`, tipoMantenimiento);
    }
  
    updateTipoMantenimiento(id: number, tipoMantenimiento: TiposMantenimientos) {
      return this.http.put<TiposMantenimientos>(`${this.apiUrl}/tiposmantenimientos/${id}`, tipoMantenimiento);
    }
  
    deleteTipoMantenimiento(id: number) {
      return this.http.delete<TiposMantenimientos>(`${this.apiUrl}/tiposmantenimientos/${id}`);
    }
    ...
    updateRepostaje(id: string, repostaje: Repostajes) {
      return this.http.put<Repostajes>(`${this.apiUrl}/repostajes/${id}`, repostaje);
    }
    ...
    ConsultarMantenimientos(USUARIO_DNI:Number){
      return this.http.get<RespMantenimientos>(`${this.apiUrl}/mantenimientos/${USUARIO_DNI}`)
    }
    ...
    updateMantenimiento(id: string, mantenimiento: Mantenimientos) {
      return this.http.put<Mantenimientos>(`${this.apiUrl}/mantenimientos/${id}`, mantenimiento);
    }
  
    deleteMantenimiento(id: string) {
      return this.http.delete<Mantenimientos>(`${this.apiUrl}/mantenimientos/${id}`);
    }
    ...
    // Establecimientos
    getEstablecimientos() {
      return this.http.get<RespEstablecimientos>(`${this.apiUrl}/establecimientos`);
    }
  
    addEstablecimiento(establecimiento: Establecimientos) {
      return this.http.post<Establecimientos>(`${this.apiUrl}/establecimientos`, establecimiento);
    }
  
    updateEstablecimiento(id: number, establecimiento: Establecimientos) {
      return this.http.put<Establecimientos>(`${this.apiUrl}/establecimientos/${id}`, establecimiento);
    }
  
    deleteEstablecimiento(id: number) {
      return this.http.delete<Establecimientos>(`${this.apiUrl}/establecimientos/${id}`);
    }
  }
